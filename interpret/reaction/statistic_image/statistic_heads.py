...
def extract_first_dict(row):
    if pd.isna(row):  # Check if it is empty.
        return None
    # Separate by comma and extract the first part.
...
file_name='data/result/statistics_reactive/double_para/df_ratio_multi_0.90_0.99_v02_202501010.xlsx'
...
ratio_multi_first='data/result/statistics_reactive/double_para/find_heads/df_ratio_multi_first.xlsx'
...
ratio_multi_second='data/result/statistics_reactive/double_para/find_heads/df_ratio_multi_second.xlsx'
...
ratio_multi_third='data/result/statistics_reactive/double_para/find_heads/df_ratio_multi_third.xlsx'
...
##show results ###
ratio_multi_first_1='data/result/statistics_reactive/double_para/find_heads/df_ratio_multi_first_v01.xlsx'
...
ratio_multi_second_1='data/result/statistics_reactive/double_para/find_heads/df_ratio_multi_second_v01.xlsx'
...
ratio_multi_third_1='data/result/statistics_reactive/double_para/find_heads/df_ratio_multi_third_v01.xlsx'
...
# plt.tight_layout()
data_files_smiles='data/result/statistics_reactive/double_para/find_heads'
