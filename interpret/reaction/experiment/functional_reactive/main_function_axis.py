...
criterion_excel=f'double_criterion_100.xlsx'  #save functional group path
...
function_path= os.path.join(folder_statistics_path, function_excel)
...
statistics_atoms_number_path = os.path.join(folder_statistics_path, atoms_number_excel)
...
single_row_number_path = os.path.join(folder_statistics_path, single_row_excel)
