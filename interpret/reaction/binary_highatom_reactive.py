...
def highlight_chemical_atoms(folder_path,file_path_decrease_one_npy,file_path_decrease_two_npy,filename_without_extension,saving_img_flag,ratio,smiles_address):
