...
statistics_path = 'data/result/statistics_reactive/double_para'
ratio_excel = f'df_ratio_multi_0.97_0.99_{head}.xlsx'  # save functional group path
...
for ratio_adaptive in np.arange(0.970, 0.999, 0.001):
    # ratio_adaptive = 0.99
    if single_ratio_flag:
        ratio_adaptive=0.99
    else:
        data_files_npy='data/middle_attention/npy_reactive/double_molecule_para'
    ...
    input_files_smiles = os.path.join(parent_dir, 'data/result/statistics_reactive/double_para')
    ...
    if single_ratio_flag:
        ...
        df_frag_smiles_multi.to_excel(os.path.join(input_files_smiles, frag_multi_excel))
