...
filename_combine= os.path.join(parent_dir, 'data/result/statistics_reactive/double_para/combine')
...
df_criterion = pd.read_excel(os.path.join(filename_combine, 'double_criterion_100.xlsx'))
