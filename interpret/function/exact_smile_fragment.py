...
def extract_specified_atoms(smiles, atom_indices):
    # Use RDKit to parse a SMILES string.
    mol = Chem.MolFromSmiles(smiles)

    # Create a new molecule editing object.
    ...
    # Get the SMILES representation of the fragment.
...
if __name__ == "__main__":
    ...
    # Example input: SMILES string and atomic positions.
    # smiles = "CC(=O)OC1=CC=CC=C1C(=O)O"  # Aspirin.
    # atom_indices = [0,1,3]  # Specify the atomic positions to retain.
    smiles = "C=CC1=CC=CC=C1.O=CCC"  # Aspirin.
    atom_indices = [0,5,8,9]  # Specify the atomic positions to keep.
